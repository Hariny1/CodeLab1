package com.example.harinyg.codelab1;
...
public class CodeLab1Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        button1.setOnClickListener(new View.OnClickListener() {
            ...
            {
                Intent receivedIntent1 = getIntent();
                //Get String extra from activity using key
                String receivedName = receivedIntent1.getStringExtra("name_to_be_displayed");
                Toast.makeText(CodeLab1Activity.this, receivedName+" made a toast!!!!", Toast.LENGTH_SHORT).show();
            }
        });
